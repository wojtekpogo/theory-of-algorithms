...
* *countdown* - Contains an overview, explanation and discusses the complexity of the **Countdown Numbers Game**. It also contains Python function written in a [functional programming style](https://docs.python.org/3/howto/functional.html) which solves a **Countdown Numbers Game** as well as an explanation of a functional aspect of the code.
...
2. Open Git Bash
3. Clone this repository (*see above*)
4. Run `cd theory-of-algorithms`
5. Run `jupyter-lab`
6. Optionally you can restart and run all cells in the notebook

```diff
! Disclaimer
Jupyter should automatically run in the browser
if not, then copy localhost address provided in the command prompt and
